...
public class SetInterface {
	...
	public static void main(String[] args) {
		...
		if(emailSet.contains("john@example.com")) {
		...
		/*System.out.println("3. Iterating using list iterator");
		ListIterator<String> listitr = emailSet.list
		 ListIterator can't be used in set, only used in lists*/ 
			}
