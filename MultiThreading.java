...
// Inheritance: BookMyShowMovieTicketTask is the child of Thread class
...
class PayTMMovieTicketTask extends PaymentTask implements Runnable{
	public void run() {// run is mandatory to be used
		for(int i=1;i<=5;i++) {
...
public class MultiThreading {
	...
	// main is executed automatically whenever a program runs
	// we say main is the method which contains some tasks, these tasks are the instructions inside the main method
