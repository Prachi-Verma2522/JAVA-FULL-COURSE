...
// We need inheritance in order to reduce code length and why to create that variables which are already defined in a class, by inheritance- code 
// re-useability will occcur. 
...
public class WhyInheritance {
	...
	public static void main(String[] args) {
		...
		// Polymorphic Statement:- reference variable of parent can refer to the child object
